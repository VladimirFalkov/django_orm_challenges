...
from challenges.views.level_2.a_laptops import (
    laptop_details_view,
    laptop_in_stock_list_view,
    laptop_filter_view,
    last_laptop_details_view,
)
from challenges.views.level_2.b_blog import (
    last_posts_list_view,
    posts_search_view,
    untagged_posts_list_view,
    categories_posts_list_view,
    last_days_posts_list_view,
)
